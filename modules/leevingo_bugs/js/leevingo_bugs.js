(function ($) {
  ...
  Drupal.behaviors.bugs = {
    attach: function (context, settings) {

      var config = drupalSettings.leevingo_bugs.config;
      ...
      var BugDispatch = {
        ...
        options: {
          ...
          maxSmallTurnDeg: 10,
          maxWiggleDeg: 5,
          imageSprite: '../modules/custom/leevingo_modules/modules/leevingo_bugs/images/fly-sprite.png',
          bugWidth: 13,
          bugHeight: 14,
          num_frames: 5,
      ...
      var FlyController = function () {
        var flyOptions = {
          imageSprite: '../modules/custom/leevingo_modules/modules/leevingo_bugs/images/fly-sprite.png',
          minBugs: config.bugs_fly_settings_min,
          maxBugs: config.bugs_fly_settings_max,
          mouseOver: 'fly'
        };
        this.options = mergeOptions(this.options, flyOptions);
      ...
      var SpiderController = function () {
        var spiderOptions = {
          imageSprite: '../modules/custom/leevingo_modules/modules/leevingo_bugs/images/spider-sprite.png',
          bugWidth: 69,
          bugHeight: 90,
          num_frames: 7,
          canFly: false,
          ...
          minSpeed: 6,
          maxSpeed: 13,
          minBugs: config.bugs_spider_settings_min,
          maxBugs: config.bugs_spider_settings_max,
          mouseOver: 'die'
        };
...
// see http://jsperf.com/obj-vs-prototype-vs-other
      ...
      if (config.bugs_fly_enable) {
        new FlyController({});
      }
      if (config.bugs_spider_enable) {
